...
This is a copy of the configuration that has been read in from
namelists for the particular instance of the model. See the
configuration documentation (TBA) for more details.
