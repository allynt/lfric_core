...
contains
  ...
  !>        which contains a single global mesh.
  !>
  ...
  !===========================================================================
  !> @brief Requests a global mesh object with specified global_mesh_id from
  !>        the collection.
  !>
  !> @param[in] global_mesh_id ID of global mesh object to retrieve.
  !>
